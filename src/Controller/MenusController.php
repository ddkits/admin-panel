...
class MenusController extends Controller
{
    ...
    {
         $menu = Menus::orderby('created_at', 'desc')->get();
            return view('adminpanel::admin.menu.index')->withMenus($menu);
    }
     /**
     * Display a listing of the resource.
     *
    ...
    {
         $menus1 = Menus::where('menu', 'adminmenu')->get();
...
/**
    ...
    {
        return view('adminpanel::admin.menu.create');
    }
